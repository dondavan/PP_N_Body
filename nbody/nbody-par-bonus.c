...
/* Describes which two body will be computed*/
struct job
{
    int bodyPar[2];
};
...
main(int argc, char **argv)
{
    ...
    /* Buffer for parallel communication */
    /* Would be uesed for force, velocity, position communication */
    double * world_buf_X_1 = malloc(world->bodyCt*(sizeof(double)));
    double * world_buf_Y_1 = malloc(world->bodyCt*(sizeof(double)));
